                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><a href="registro"><b>No tienes cuenta? Registrate.</b></a></p>
                                    </div>
                                        ...
                                        if(isset($_GET["action"])){
                                            if($_GET["action"] == "registro_ok"){
                                                ...
                                                echo "Error al ingresar, su usuario o contraseña no cumple con los requerimientos minimos(usuario: letras, numeros y guíones.Contraseña:Minimo 8 caracteres, una letra y un numero";
